...
typedef enum _Telemetry__Severity {
  ...
  TELEMETRY__SEVERITY__SEVERITY_URGENT = 3
...
#define TELEMETRY__RECORD__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&telemetry__record__descriptor) \
    , TELEMETRY__RESOURCE__RESOURCE_UNSPECIFIED, 0, 0, (char *)protobuf_c_empty_string, 0, {0,NULL}, TELEMETRY__SEVERITY__SEVERITY_UNSPECIFIED, 0, 0 }
...
#define TELEMETRY__TELEMETRY_PACK__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&telemetry__telemetry_pack__descriptor) \
    , 0,NULL, TELEMETRY__RESOURCE__RESOURCE_UNSPECIFIED, 0, TELEMETRY__NETWORK_TYPE__NETWORK_TYPE_UNSPECIFIED, {0,NULL} }
